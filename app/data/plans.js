export const plans = [
  {
    id: "function", name: "Plan Function", eyebrow: "Una web que también trabaja por tu negocio",
    ...
    message: "Hola, quiero consultar sobre el Plan Function.", hasModal: true,
  },
  {
    id: "impacto", name: "Plan Impacto", badge: "Recomendado para comenzar", eyebrow: "Para empezar a destacar en internet",
  ...
  {
    id: "system", name: "Plan System", eyebrow: "Un sistema completo desarrollado a medida",
...
export const comparison = [
  ["Web informativa", true, true, true], ["Diseño personalizado", true, true, true],
  ["Responsive", true, true, true], ["SEO inicial", true, true, true], ["AWS", true, true, true],
  ["Cloudflare", true, true, true], ["Dominio y SSL", true, true, true],
  ["Formularios", "Contacto", "Avanzados", "A medida"], ["Panel administrativo", false, true, true],
  ["Usuarios y roles", false, true, true], ["Automatizaciones", false, true, true],
  ["Informes", false, true, true], ["Integraciones", false, true, true],
  ["Mejoras evolutivas", false, true, true], ["Soporte prioritario", false, true, true],
  ["Sistema completamente a medida", false, false, true],
];
