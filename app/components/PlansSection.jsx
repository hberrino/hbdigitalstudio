...
export default function PlansSection() {
  ...
  return (
    <section className="plans section" id="planes"><div className="container">
      ...
      <SectionHeading eyebrow="Planes" title="Elegí la solución adecuada para tu negocio" text="Desde una presencia digital profesional hasta un sistema completamente adaptado a tu operación." align="center" />
      <div className="plans__grid">{plans.map((plan) => <PlanCard plan={plan} key={plan.id} onInfo={() => setFeaturesOpen(true)} />)}</div>
      ...
      <div className="plans__compare reveal">
        ...
        <button type="button" onClick={() => setComparisonOpen(true)}>
          <Scale size={18} /> Comparación de planes <ArrowUpRight size={17} />
        </button>
      </div>
    </div>
