      ...
      <div className="container hero__grid">
        <div className="hero__copy">
          ...
          <div className="hero__commercial-promises">
            ...
            <div className="hero__promise"><span><CheckCircle2 size={19} /></span><p>Tu tranquilidad forma parte del proyecto: <strong>terminás de abonar cuando el resultado cumple tus expectativas.</strong></p></div>
          </div>
